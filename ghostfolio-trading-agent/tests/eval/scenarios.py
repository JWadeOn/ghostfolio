    ...
    "single_tool": {
        ...
        "edge": [
            ...
            },
            {
                ...
                "expected_tools_any": ["trade_guardrails_check", "get_market_data", "get_portfolio_snapshot"],
    ...
    "multi_tool": {
        ...
        "investment_evaluation": [
            ...
            },
            {
                ...
                "expected_tools": ["get_portfolio_snapshot"],
                "expected_tools_plus_any_of": ["portfolio_guardrails_check", "trade_guardrails_check"],
        ...
        "comprehensive": [
            {
                ...
                "expected_tools": ["get_portfolio_snapshot"],
                "expected_tools_plus_any_of": ["get_trade_history", "compliance_check", "portfolio_guardrails_check"],
                "expected_output_contains": ["portfolio"],
            ...
            },
            {
                ...
                "expected_tools": ["get_portfolio_snapshot"],
                "expected_tools_plus_any_of": ["compliance_check", "tax_estimate", "portfolio_guardrails_check", "get_trade_history"],
