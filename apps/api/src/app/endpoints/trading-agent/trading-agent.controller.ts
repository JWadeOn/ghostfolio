...
export class TradingAgentController {
  public constructor(private readonly tradingAgentService: TradingAgentService) {}

  @Post('chat')
  @HasPermission(permissions.readAiPrompt)
  @UseGuards(AuthGuard('jwt'), HasPermissionGuard)
  public async chat(@Body() body: TradingAgentChatDto): Promise<TradingAgentChatResponse> {
